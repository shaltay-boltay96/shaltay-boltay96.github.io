var persons = [
    ...
    },
    {
        ...
        is_alone: null,
        image: 'boner.jpg',
        desc: 'Роза Бонёр — французская художница-анималист 19 века. Ее профессиональное творчество было огромной редкостью в то время. По натуре она была очень сильным и стойким человеком. Она боролась за право творить на ровне с мужчинами. При этом ее картины наполнены нежностью и любовью к миру.'
    },
    {
        type: 'draw',
        name: 'Мэри Мозер',
        ...
        is_alone: null,
        image: 'mozer.jpg',
        desc: 'Мэри Мозер — английская художница, одна из первых женщин, членов Королевской академии художеств. Писала преимущественно натюрморты с цветами. Была бриллиантом своего времени как самодостаточная женщина и профессиональный художник, получающий за своей творчество хорошие деньги.'
    },
    {
        type: 'english',
