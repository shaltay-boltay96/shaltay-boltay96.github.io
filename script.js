var persons = [
    ...
    },
    {
        ...
        desc: 'Василий Кирииллович Тредиаковский — русский поэт, переводчик и филолог XVIII века. В своих лингвистических взглядах придерживался принципа конструктивизма. Был блистательным переводчиком, подарив соотечественникам лучшие лингвистические труды и художественные произведения того времени.'
    },
    {
        type: 'english',
        ...
        is_alone: null,
        image: 'balmond.jpg',
        desc: 'Константин Дмитриевич Бальмонт — русский поэт-символист, переводчик и эссеист. Его переводческая деятельность—значительный вклад в русскую культуру. Знание многих языков позволило ему открыть для читателя большое количество имен английской, французской, американской, испанской, армянской, польской и других литератур. Значительное место в творчестве русского поэта занимает английская литература. Он перевел произведения Д. Байрона, Р. Бернса, В. Блейка У. Шекспира, Б. Шелли, Т. Эллиота и др.'
    },
    {
        type: 'english',
        name: 'Дмитрий Пучков',
        ...
        is_alone: null,
        image: 'puchkov.jpg',
        desc: 'Дмитрий Пучков — российский писатель, публицист и переводчик, разработчик компьютерных игр. Вы не поверите, всего за 2 месяца он выучил английский так, что смог переводить фильмы. Его пример—образец для всех, кто действительно хочет.'
    },
];
